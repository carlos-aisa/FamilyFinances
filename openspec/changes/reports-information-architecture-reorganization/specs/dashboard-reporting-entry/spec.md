...
- **AND** the Reports route family entry surface (`/reports`) MUST include direct discoverability for all intended report deep-dive cards, including `/reports/asset-total-balance`
