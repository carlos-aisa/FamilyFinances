...
The API MUST expose a month-level dataset contract for chart rendering.
...
The reporting UI MUST render month-level charts using the dedicated datasets.

#### Scenario: Month selector refreshes monthly charts
- **WHEN** the user changes the selected month in reporting filters
