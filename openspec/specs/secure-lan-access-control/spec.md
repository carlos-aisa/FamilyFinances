# secure-lan-access-control Specification

## Purpose
Define secure LAN exposure controls for installer-managed deployments, including local-only defaults, explicit HTTPS opt-in, loopback API isolation, local certificate lifecycle, and protected host operations.
