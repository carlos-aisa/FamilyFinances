# github-actions-quality-gates Specification

## Purpose
Define repository-level CI quality workflow and branch governance requirements in GitHub Actions, including coverage visibility and storage-aware evidence publication.
