# Fiscal Year Governance Specification

## Purpose
Define reversible fiscal-year close governance, year-end snapshot behavior, mutation guards for closed years, and governance API expectations.
