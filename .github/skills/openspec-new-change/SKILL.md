...
2. **CRITICAL: Ask Detailed, In-Depth Questions**
   ...
   **If you can't mentally sketch these, ask more questions.**
   ...
   > "This sounds like it might need some exploration to work through the details. Would you like to use explore mode first (opsx:explore) to think through the design before creating the change?"
